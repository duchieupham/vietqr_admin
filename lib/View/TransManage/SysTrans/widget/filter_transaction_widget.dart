...
class _FilterTransactionWidgetState extends State<FilterTransactionWidget> {
  ...
  Widget build(BuildContext context) {
    final List<ItemSearch> listHintSearch = [
      ItemSearch(id: 1, title: 'số tài khoản'),
      ItemSearch(id: 2, title: 'mã giao dịch'),
      ItemSearch(id: 3, title: 'order id'),
      ItemSearch(id: 4, title: 'nội dung'),
      ItemSearch(id: 5, title: 'cửa hàng'),
    ];
