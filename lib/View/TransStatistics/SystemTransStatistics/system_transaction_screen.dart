...
import 'package:vietqr_admin/View/TransStatistics/SystemTransStatistics/widgets/item_right_widget.dart';
import 'package:vietqr_admin/View/TransStatistics/SystemTransStatistics/widgets/item_system_transaction_widget.dart';
...
class SystemTransStatisticsScreen extends StatefulWidget {
  const SystemTransStatisticsScreen({super.key});

  @override
  State<SystemTransStatisticsScreen> createState() =>
      _SystemTransStatisticsScreenState();
}

class _SystemTransStatisticsScreenState
    extends State<SystemTransStatisticsScreen> {
