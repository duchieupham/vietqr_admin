...
class TitleRowItemWidget extends StatelessWidget {
  final ScrollController controller;
  final MerchantExtra? extra;
  const TitleRowItemWidget(
      {super.key, required this.extra, required this.controller});
  ...
  Widget _buildItemTitle(String title,
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        border:
            Border(left: BorderSide(color: AppColor.GREY_DADADA, width: 0.5)),
      ),
      child: Text(
        title,
        textAlign: textAlign,
